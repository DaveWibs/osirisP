    ...
    IF EXISTS (
        ...
        WHERE table_schema = 'public'
          AND (
              ...
              OR (table_name = 'internet_outage_observations' AND column_name = 'evidence_classification')
              OR (table_name = 'market_quote_observations' AND column_name = 'evidence_classification')
