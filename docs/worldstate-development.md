...
| `WEATHER_DATA_MODE` | `live` | Weather compatibility source; database mode serves persisted EONET/NWS weather events (GDACS cyclones/floods/droughts remain live-only) |
