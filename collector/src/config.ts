...
const OFFICIAL_ADSB_LOL_HOST = "api.adsb.lol";
...
const environmentSchema = z.object({
  ...
  ADSB_LOL_MILITARY_URL: z.string().url().default(DEFAULT_ADSB_LOL_MILITARY_ENDPOINT),
...
export function loadConfig(environment: NodeJS.ProcessEnv = process.env): CollectorConfig {
  ...
  return {
    ...
    bbcWorldRssEndpoint: validateSatelliteEndpoint(
      parsed.BBC_WORLD_RSS_URL,
      "BBC_WORLD_RSS_URL",
      OFFICIAL_BBC_RSS_HOST,
    ),
    aljazeeraAllRssEndpoint: validateSatelliteEndpoint(
      parsed.ALJAZEERA_ALL_RSS_URL,
      "ALJAZEERA_ALL_RSS_URL",
      OFFICIAL_ALJAZEERA_RSS_HOST,
    ),
    gdacsNewsRssEndpoint: validateSatelliteEndpoint(
    ...
    adsbLolMilitaryEndpoint: validateSatelliteEndpoint(
      parsed.ADSB_LOL_MILITARY_URL,
      "ADSB_LOL_MILITARY_URL",
      OFFICIAL_ADSB_LOL_HOST,
    ),
